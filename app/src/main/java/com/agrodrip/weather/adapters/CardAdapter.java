package com.agrodrip.weather.adapters;
...
public class CardAdapter extends RecyclerView.Adapter<CardAdapter.CardViewHolder> {
    ...
    public CardAdapter(List<DataObject> dataObjects) {
        this.dataSet = dataObjects;
    }
    ...
    public void onBindViewHolder(final CardViewHolder holder, final int listPosition) {
        ...
        holder.textViewTemperature.setText((int)thisObject.getMain().getTemp() + Constants.TEMP_UNIT);
...
//                holder.cardView.setBackgroundResource(R.color.color_mix_snow_and_rain);
    ...
    private String getTime(Long milliTime) {
        ...
        SimpleDateFormat df = new SimpleDateFormat("E, MMM dd yyyy  hh:mm a");
