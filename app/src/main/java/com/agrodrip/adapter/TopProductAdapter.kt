...
class TopProductAdapter(val context: Context, var alist: ArrayList<TopProductData>, var comeFrom: String, val itemClick: OnItemClick) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val v: View = LayoutInflater.from(parent.context).inflate(R.layout.item_top_product, parent, false)
